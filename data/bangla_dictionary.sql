...
--
-- Host: localhost
-- Generation Time: Jul 21, 2012 at 06:39 PM
...
CREATE TABLE IF NOT EXISTS `bangla_words` (
  ...
  `parts_of_speech_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `bangla_word_UNIQUE` (`bangla_word`),
  KEY `bangla_words_fk_parts_of_speech` (`parts_of_speech_id`)
...
INSERT INTO `bangla_words` (`id`, `bangla_word`, `parts_of_speech_id`) VALUES
(3, 'hello', 1);
...
CREATE TABLE IF NOT EXISTS `english_word_expamles` (
  ...
  `english_words_id` int(10) unsigned DEFAULT NULL COMMENT 'this is a foreign key of english_words table',
  `sentence` varchar(300) DEFAULT NULL COMMENT 'this column will store sentences',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `parts_of_speech` (
  ...
  `parts_of_speech` varchar(45) NOT NULL COMMENT 'Name of the parts of speech',
  PRIMARY KEY (`id`),
  UNIQUE KEY `parts_of_speech_UNIQUE` (`parts_of_speech`)
...
INSERT INTO `parts_of_speech` (`id`, `parts_of_speech`) VALUES
(1, 'noun');
...
ALTER TABLE `bangla_words`
  ADD CONSTRAINT `bangla_words_fk_parts_of_speech` FOREIGN KEY (`parts_of_speech_id`) REFERENCES `parts_of_speech` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `english_words`
  ADD CONSTRAINT `english_words_fk_parts_of_speech` FOREIGN KEY (`parts_of_speech_id`) REFERENCES `parts_of_speech` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
